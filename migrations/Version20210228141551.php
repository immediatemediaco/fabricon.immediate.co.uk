 ...
 */
final class Version20210228141551 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE slot (id INT NOT NULL, track1_id INT DEFAULT NULL, track2_id INT DEFAULT NULL, start_time TIME(0) WITHOUT TIME ZONE DEFAULT NULL, end_time TIME(0) WITHOUT TIME ZONE DEFAULT NULL, break_details VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
